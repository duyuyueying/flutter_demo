class TravelModel{
  ...
  factory TravelModel.fromJson(Map<String, dynamic> json) {
    var travelItemsJson = json['travelItems'] as List;
    List<TravelItem> travelItems = travelItemsJson.map((item)=>TravelItem.fromJson(item)).toList();
    return TravelModel(
...
class TravelItem{
  final int type;
  final Article aritical;

  TravelItem({this.type, this.aritical});
  factory TravelItem.fromJson(Map<String, dynamic> json) {
    return TravelItem(
      type: json['type'],
      aritical: Article.fromJson(json['artical'])
    );
  }
  }
